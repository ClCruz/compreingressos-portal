...
//    private List<SelectItem> filterFaseContrato;
	...
	public void retrieveTasks() {   
        ...
        for(TaskSummary t : taskService.getTasksAssignedAsPotentialOwner(loginController.getUsuario().getDsNome(), "en-UK")){            
	...
	public void startTask(Task task) {  
	 ...
	 public void releaseTask(Task task) {
	    ...
	    public void deleteTask(){
	        KieSession taskService = TaskBPM.getRuntimeEngine(loginController.getUsuario()).getKieSession();
...
//	            processo.setProcDsHistorico("Processo encerrado manualmente pelo usuário: "+ loginController.getUsuario().getDsNome() +". Justificativa: "+ content);
	    ...
	    public String status(String status){
	        ...
	        switch (status){
	            case "P":
	                resultado = "Em preenchimento";
	                break;
	            case "E":
	                resultado = "Enviado para aprovacao";
	                break;
	            case "A":
	                resultado = "Aprovado";
	                break;
