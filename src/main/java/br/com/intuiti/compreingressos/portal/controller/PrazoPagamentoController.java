...
public class PrazoPagamentoController implements Serializable {
	...
	public static class PrazoPagamentoControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			PrazoPagamentoController controller = (PrazoPagamentoController) facesContext.getApplication()
					.getELResolver().getValue(facesContext.getELContext(), null, "prazoPagamentoController");
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof PrazoPagamento) {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
						...
						new Object[] { object, object.getClass().getName(), PrazoPagamento.class.getName() });
				return null;
			}
		}
