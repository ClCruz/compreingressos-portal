...
public class TipoLancamentoController implements Serializable {
	...
	public void destroy() {
		if (selected.getDtInsert().compareTo(new Date()) <= 0) {
			JsfUtil.addErrorMessage(
					"Não é possível remover esse tipo de lançamento, pois a data de validade é menor que a data atual.");
		} else {
	...
	public static class TipoLancamentoControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			TipoLancamentoController controller = (TipoLancamentoController) facesContext.getApplication()
					.getELResolver().getValue(facesContext.getELContext(), null, "tipoLancamentoController");
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof TipoLancamento) {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
						...
						new Object[] { object, object.getClass().getName(), TipoLancamento.class.getName() });
				return null;
			}
		}
