...
public class ModalidadeContratoController implements Serializable {
			...
			try {
				if (persistAction != PersistAction.DELETE) {
					if (persistAction == PersistAction.CREATE) {
						...
						if (getFacade().findDsId(selected.getDsModalidadeContrato(),
								selected.getIdModalidadeContrato())) {
							getFacade().edit(selected);
							JsfUtil.addSuccessMessage(successMessage);
						} else {
							JsfUtil.addErrorMessage("Já existe uma modalide de contrato com essa descrição.");
	...
	public static class ModalidadeContratoControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			ModalidadeContratoController controller = (ModalidadeContratoController) facesContext.getApplication()
					.getELResolver().getValue(facesContext.getELContext(), null, "modalidadeContratoController");
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof ModalidadeContrato) {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
						...
						new Object[] { object, object.getClass().getName(), ModalidadeContrato.class.getName() });
				return null;
			}
		}
