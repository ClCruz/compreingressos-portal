...
public class TipoMeioPagamentoController implements Serializable {
	...
	public class Lazy extends LazyDataModel<TipoMeioPagamento> {
		...
		@Override
		public List<TipoMeioPagamento> load(int first, int pageSize, String sortField, SortOrder sortOrder,
	...
	public static class TipoMeioPagamentoControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			TipoMeioPagamentoController controller = (TipoMeioPagamentoController) facesContext.getApplication()
					.getELResolver().getValue(facesContext.getELContext(), null, "tipoMeioPagamentoController");
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof TipoMeioPagamento) {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
						...
						new Object[] { object, object.getClass().getName(), TipoMeioPagamento.class.getName() });
				return null;
			}
		}
