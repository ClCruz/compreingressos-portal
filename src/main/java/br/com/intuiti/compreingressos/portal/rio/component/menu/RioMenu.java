...
@ListenerFor(sourceClass = RioMenu.class, systemEventClass = PostAddToViewEvent.class)
public class RioMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {
